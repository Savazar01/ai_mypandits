...
async function runTests() {
  ...
  console.log("S1 Data:", JSON.stringify(data1, null, 2));
  ...
  console.log("S2 Data:", JSON.stringify(data2, null, 2));
        ...
        activities: [
          {
            ...
            status: "Pending",
            is_orchestrated: false,
            invitations: [{ invitee_name: "Test Guest", whatsapp_number: "+1234567890", num_guests: 1 }] // Add one guest for robust testing
          },
          {
  ...
  console.log("S3 Data:", JSON.stringify(data3, null, 2));


  // 5. Query Dashboard API to verify the events are loaded for the user
  ...
  // Verify DB contents directly using Prisma to make sure days and activities are correctly saved
  ...
  dbEvents.forEach(ev => {
    ...
    ev.days.forEach(day => {
      ...
      day.activities.forEach(act => {
         console.log(`      - [${act.title}] from ${act.start_time} to ${act.end_time}`);
         if (act.invitations.length > 0) {
